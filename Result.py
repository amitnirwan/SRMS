...
#title
        title=Label(self.root,text="Add Students Results", font=("goudy old style", 20,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1180,height=50)
...
#Widgets
    #variables
        ...
        lbl_cousre=Label(self.root,text="Course",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=220)
...
#=======images=======
        ...
        self.bg_img=Image.open("images/python_logo.png")
            ...
            if self.var_name.get()=="":
                ...
                if row!=None:
                   messagebox.showerror("Error","Result already present",parent=self.root)
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Result Added Successully",parent=self.root)
