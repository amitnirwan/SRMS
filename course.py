                ...
                if row==None:
                   messagebox.showerror("Error","Please select course from the list first ",parent=self.root)
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.showinfo("Delete", "Course deleted suceesfully",parent=self.root)
                        self.clear()
            ...
            if self.var_course.get()=="":
                ...
                if row!=None:
                   messagebox.showerror("Error","Course name already present",parent=self.root)
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Course Added Successully",parent=self.root)
                    self.show()
            ...
            if self.var_course.get()=="":
                ...
                if row==None:
                   messagebox.showerror("Error","Select Course from list",parent=self.root)
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Course Update Successully",parent=self.root)
                    self.show()
