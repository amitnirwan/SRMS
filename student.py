...
#column 2
        ...
        txt_admission=Entry(self.root,textvariable=self.var_admission_date,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=480,y=140,width=200)
...
#===============================================================================
                ...
                if row==None:
                   messagebox.showerror("Error","Please select student from the list first ",parent=self.root)
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.showinfo("Delete", "student deleted suceesfully",parent=self.root)
                        self.clear()
    ...
    def get_data(self,ev):
        ...
        self.var_admission_date.set(row[6]),
            ...
            if self.var_roll.get()=="":
                ...
                if row!=None:
                   messagebox.showerror("Error","Roll No. already present",parent=self.root)
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Student Added Successully",parent=self.root)
                    self.show()
            ...
            if self.var_roll.get()=="":
                ...
                if row==None:
                   messagebox.showerror("Error","Select Student from list",parent=self.root)
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Student Update Successully",parent=self.root)
                    self.show()
